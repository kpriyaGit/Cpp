...
BlockCourse::BlockCourse(std::string title,unsigned int key, std::string major,std::string sem,float creditPoints,
		Poco::Data::Date startDate, Poco::Data::Date endDate, Poco::Data::Time startTime,
		Poco::Data::Time endTime) : Course {key,title,major,sem,creditPoints} {
