...
protected:
	...
	static std::string toString(Poco::Data::Time time);
	static std::string toString(Poco::Data::Date date);
	static Poco::Data::Time timeFromString(std::string time);
	static Poco::Data::Date dateFromString(std::string date);
	Course (Poco::JSON::Object::Ptr data);
